...
if ask_for_currents_model: selected_currents_model = MRlib.menu(currents_models, "Choose currents type :") # Ask for currents model
...
#        The boat adapt its heading towards the goal          #
# ----------------------------------------------------------- #
...
plt.savefig('archive/230402 result.png', dpi=300)                                                # Save figure
